...
MAIN_MENU_BUTTON_POSITION = ((SCREEN_WIDTH) // 2 + 25, 625)
...
# message to swtich text settings(blackscreen prompt)
...
# Status bar text settings
STATUS_BAR_FONT_SIZE = 20
STATUS_BAR_TEXT_COLOR = (0, 0, 0)


# statistics and game result screen settings
