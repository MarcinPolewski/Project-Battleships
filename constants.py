...
END_SCREEN_EXIT_BUTTON_POSITION = (550, 600)


REPLAY_BUTTON_POSITION = ((SCREEN_WIDTH - BUTTON_WIDTH) // 2 - 50, 600)
REPLAY_BUTTON_POSITION = ((SCREEN_WIDTH) // 2 + BUTTON_WIDTH + 50, 600)
